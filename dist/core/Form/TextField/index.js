...
const TextField = (props) => {
    ...
    return (react_1.default.createElement(style_1.StyledBox, { display: 'flex', flexDirection: 'column', ...props },
        react_1.default.createElement(index_1.Text, { color: 'inherit', variant: 'medium', element: 'label', htmlFor: id }, label),
